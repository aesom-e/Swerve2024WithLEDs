...
public class RobotContainer {
  ...
  public static LEDSubsystem ledSubsystem = new LEDSubsystem(200, 3);
  ...
  JoystickButton partyModeButton = new JoystickButton(driverController, 7);
  ...
  private void configureBindings()
  {
    ...
    partyModeButton.onTrue(new PartyMode());
